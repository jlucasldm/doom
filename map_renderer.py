...
class MapRenderer:
    ...
    def draw_seg(self, seg, sub_sector_id):
        ...
        pg.draw.line(self.engine.screen, self.get_color(sub_sector_id), v1, v2, 2)
        pg.display.flip()
        pg.time.wait(10)
    ...
    def draw_player_pos(self):
        ...
        pg.draw.circle(self.engine.screen, 'orange', (x, y), 5)

    def draw_linedefs(self):
        for line in self.linedefs:
            p1 = self.vertexes[line.start_vertex_id]
            p2 = self.vertexes[line.end_vertex_id]
            pg.draw.line(self.engine.screen, (70, 70, 70), p1, p2, 2)

    # Remapear os valores de x para que eles sejam desenhados na tela
    ...
    def draw_vertexes(self):
        for v in self.vertexes:
            pg.draw.circle(self.engine.screen, 'white', (v.x, v.y), 3)